...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-8c64ea9a835683d1"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-8c64ea9a835683d1",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-8c64ea9a835683d1",
        "url": "https://en.wikipedia.org/wiki/Complete_graph"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Delta-conjecture (1978): consider a complete graph $(V;E_{1},\\dots ,E_{d})$ each edge of which is colored by one of $d$ colors such that there exists a triangle $\\Delta $ colored in three pairwise distinct colors. Then, in each chromatic component $(V,E_{i}),i=1,\\dots ,d$ , one can choose a maximal independent vertex-set such that the intersection of the obtained $d$ sets is empty.",
      "version": 1
    },
    "title": "Delta-conjecture (1978)",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "3904d9a32b5a354d297367168f2dce9eed211280b7b52eca4a8de5e738520250"
}
```
